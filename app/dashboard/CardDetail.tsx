...
const detailData: Record<string, {
  ...
  dailySales: {
    subtitle: "নতুন অর্ডার তৈরি করুন",
    rows: [
      { label: "গ্রাহক নির্বাচন", value: "ডাটাবেজ থেকে", change: "—", up: true },
      { label: "পণ্য নির্বাচন", value: "ছবি/নাম ভিউ", change: "—", up: true },
      { label: "পরিমাণ", value: "ম্যানুয়ালি বসান", change: "—", up: true },
      { label: "মূল্য", value: "ম্যানুয়ালি বসান", change: "—", up: true },
    ],
    insights: [
      "গ্রাহকের নাম ডাটাবেজ থেকে নির্বাচন করুন।",
      "পণ্য সিলেক্ট করার জন্য আপলোড করা ছবি/নাম গুলো প্রডাক্ট ভিউ আকারে দেখানো হবে।",
      "পণ্য নির্বাচনের পর পরিমাণ ও মূল্য ম্যানুয়ালি বসানোর ব্যবস্থা রয়েছে।",
    ],
    periods: [
      { label: "মোট গ্রাহক", value: "৪,২৯১ জন" },
      { label: "সক্রিয় পণ্য", value: "১১৮ টি" },
      { label: "আজকের অর্ডার", value: "২৮ টি" },
      { label: "গড় মূল্য", value: "৳ ১,২৫০" },
    ],
  },
  profit: {
